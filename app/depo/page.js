...
export default function DepositBaruPage() {
  return (
    <div className="flex flex-col min-h-[calc(100vh-120px)] justify-between space-y-6">
      ...
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-normal text-slate-800 dark:text-white">Deposit Baru</h1>
            ...
            <table className="w-full border-collapse text-left text-xs border border-slate-300 dark:border-slate-700">
              <thead>
                <tr className="text-slate-700 dark:text-slate-300 font-semibold bg-slate-50 dark:bg-slate-800/40">
                  ...
                  <th className="border border-slate-300 dark:border-slate-700 p-2.5">Nomor Seri</th>
              ...
              <tbody>
                <tr>
                  <td colSpan={15} className="border border-slate-300 dark:border-slate-700 text-center py-8 text-slate-500 dark:text-slate-400">
                    Tidak ada data
                  </td>
                </tr>
              </tbody>
