  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-120px)] justify-between space-y-6">
      ...
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-normal text-slate-800 dark:text-white">Rangkuman Withdrawal</h1>
          <div className="flex items-center space-x-1.5 text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            ...
            <span>/</span>
            <span>Rangkuman Withdrawal</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded shadow-sm">
          ...
          <div className="p-5 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              {/* Dari Tanggal Withdrawal */}
              <div className="border border-slate-300 dark:border-slate-700 rounded bg-white dark:bg-slate-800 px-3 py-1.5 focus-within:border-blue-500">
                <label className="block text-[11px] text-slate-500 dark:text-slate-400 font-normal">Dari Tanggal Withdrawal</label>
                <input 
                  type="date" 
              ...
              {/* Sampai Tanggal Withdrawal */}
              <div className="border border-slate-300 dark:border-slate-700 rounded bg-white dark:bg-slate-800 px-3 py-1.5 focus-within:border-blue-500">
                <label className="block text-[11px] text-slate-500 dark:text-slate-400 font-normal">Sampai Tanggal Withdrawal</label>
                <input 
                  type="date" 
                  defaultValue="2026-07-23" 
                  className="w-full bg-transparent text-sm text-slate-700 dark:text-slate-200 focus:outline-none"
              ...
              {/* Total Withdraw */}
              <div className="border border-slate-300 dark:border-slate-700 rounded bg-white dark:bg-slate-800 px-3 py-1.5 focus-within:border-blue-500">
                <label className="block text-[11px] text-slate-500 dark:text-slate-400 font-normal">Total Withdraw</label>
                <input 
                  type="text" 
                  className="w-full bg-transparent text-sm text-slate-700 dark:text-slate-200 focus:outline-none"
                />
        ...
        {/* Kotak Utama Rangkuman Withdrawal */}
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded shadow-sm">
          {/* Header Tabel */}
          <div className="bg-slate-100 dark:bg-slate-800/60 px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center space-x-2 text-slate-700 dark:text-slate-200 text-sm font-medium">
          ...
          {/* Kotak Ringkasan Total Withdrawal di Atas Tabel */}
          <div className="p-4">
            <div className="bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded p-3 max-w-xs">
              <span className="block text-xs text-slate-500 dark:text-slate-400">Total Withdrawal</span>
            ...
            <table className="w-full border-collapse text-left text-xs border border-slate-300 dark:border-slate-700">
              ...
              <tbody>
                <tr className="text-slate-700 dark:text-slate-200">
                  ...
                  <td className="border border-slate-300 dark:border-slate-700 p-2.5 text-blue-600 dark:text-blue-400 font-medium">Alfat1</td>
                  <td className="border border-slate-300 dark:border-slate-700 p-2.5">0</td>
                  <td className="border border-slate-300 dark:border-slate-700 p-2.5">
                    DANA - 082188359992<br />
                    <span className="text-[10px] text-slate-500">a.n SIDIQ</span>
                  </td>
                  <td className="border border-slate-300 dark:border-slate-700 p-2.5">23 July 2026, 07:32:15</td>
                  <td className="border border-slate-300 dark:border-slate-700 p-2.5">
                    ...
                    <div className="text-[10px] text-slate-500 mt-0.5">23 July 2026, 07:35:02</div>
                  </td>
                  <td className="border border-slate-300 dark:border-slate-700 p-2.5 font-medium">ROBOT WITHDRAW</td>
                </tr>
              </tbody>
            </table>
          </div>
